...
// Updated Regex to handle "St. Louis" and spaces
    // This version removes both dots and spaces for a clean filename
    const file1 = (t1.city + t1.nickname).replace(/[.\s]+/g, '');
    const file2 = (t2.city + t2.nickname).replace(/[.\s]+/g, '');
    
    logo1.src = `../data/logos/${file1}.png`;
    logo2.src = `../data/logos/${file2}.png`;
